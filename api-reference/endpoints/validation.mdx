...
Validate user requests in real-time using the Limitly API.
...
| 404 | `API_KEY_NOT_FOUND` | User API key not found |
| 404 | `USER_NOT_FOUND` | User not found |
| 404 | `PLAN_NOT_FOUND` | User's plan not found |
| 429 | `RATE_LIMIT_EXCEEDED` | User has exceeded their rate limit |
...
- [API Key Management](/api-reference/endpoints/api-keys) - Manage API keys
- [Plans](/api-reference/endpoints/plans) - Manage usage plans
- [Users](/api-reference/endpoints/users) - Manage user accounts 